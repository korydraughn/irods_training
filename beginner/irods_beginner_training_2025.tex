...
Current Consortium members include RENCI, Bayer, The National Institute of Environmental Health Sciences (NIEHS), Wellcome Sanger Institute, Utrecht University, University of Groningen, SURF, Texas Advanced Computing Center (TACC), Maastricht University, KU Leuven, CUBI at Berlin Institute of Health, Bibliothèque et Archives nationales du Québec (BAnQ), CINES, Omnibond, The Council for Scientific and Industrial Research (CSIR), University of Arizona, IT4Innovations National Supercomputing Center, Globus, Wageningen University and Research (WUR), The Netherlands Cancer Institute (NKI), and three organizations that wish to remain anonymous. Membership is open to anyone interested in sustaining iRODS' success and participating in the iRODS community.
...
If using PostgreSQL 15.0+, set the owner of the database:
...
\begin{lstlisting}
$ wget https://github.com/irods/irods_training/raw/ugm2025/beginner/training_jpgs.zip
...
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2025/beginner/example_delay.r}{\usebox{\exampleDelayRule}}
...
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2025/beginner/training.re}{\usebox{\lstTrainingRuleBase}}

\vspace{5mm}
\begin{lrbox}{\lstPythonRulebase}
\lstinputlisting[language=Python,basicstyle=\scriptsize\ttfamily]{core.py}
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2025/beginner/core.py}{\usebox{\lstPythonRulebase}}
...
\end{lstlisting}
\end{lrbox}
\href{https://github.com/irods/irods_training/blob/ugm2025/beginner/server_config.json#L41-L45}{\usebox{\lstServerConfigA}}
...
\end{lstlisting}
\end{lrbox}
\href{https://github.com/irods/irods_training/blob/ugm2025/beginner/server_config.json#L56-L59}{\usebox{\lstServerConfigB}}

Save the file, then issue the following command to reload the server configuration.
...
\begin{lstlisting}
$ wget https://github.com/irods/irods_training/raw/ugm2025/stickers.jpg
$ iput stickers.jpg
\end{lstlisting}
